...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.android.example.paging.pagingwithnetwork.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.android.example.paging.pagingwithnetwork.GlideOptions().apply(toSet));
    }
  }
}
